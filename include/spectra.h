...
struct spectra {
  ...
  int index_tr_delta_sfdm;      /**< index of scalar field dark matter transfer function */
  ...
  int index_tr_theta_sfdm;      /**< index of scalar field dark matter velocity transfer function */
